...
<nav>
    ...
    <div class="header">
        <a href="${pageContext.request.contextPath}"><img
                src="${pageContext.request.contextPath}/static/images/fore/WebsiteImage/logo1.png" height="60" width="200"></a>
    ...
    <div class="context_info">
        ...
        <div class="context_buy">
            <script>
                $(function () {
                    //点击购买按钮时
                    $(".context_buy_form1").submit(function () {
            ...
            <form method="get" class="context_buy_form1">
