    ...
    <div class="header">
        <div id="mallLogo">
            <a href="${pageContext.request.contextPath}">
                <img src="${pageContext.request.contextPath}/static/images/fore/WebsiteImage/logo1.png">
...
<div class="content">
    ...
    <div class="form-list">
        ...
        <div class="form-item">
            ...
            <a href="${pageContext.request.contextPath}/login" style="color:#FA0808">返回登录</a>
        </div>
    </div>
</div>
