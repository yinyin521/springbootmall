...
public class Product {
    ...
    private Double product_price; // 产品原价
    private Double product_sale_price; // 产品售价
    private Date product_create_date; // 产品创建日期
    private Integer product_category_id; // 产品类别编号
    private Category product_category; // 产品种类
    ...
    private List<Review> reviewList; // review对象列表
